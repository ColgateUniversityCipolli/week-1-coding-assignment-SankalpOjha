...
\textbf{Solution:} The fifth element in the vector is the solution which means x must equal 4 (x = 4) for the equation to equal 40.
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % QUESTION 2e
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \item Explain why this approach wouldn't work for something like $3^{x+2} + 5 (3^x) = 84$ where the solution is $x \approx 1.6309$.\\
\textbf{Solution:} As 1.6309 is \textbf{NOT} an integer, the method used earlier will fail for this question as 1.6309 is not a value in the vector.
\end{enumerate}
\end{enumerate}
