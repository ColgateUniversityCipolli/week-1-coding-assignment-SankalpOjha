...
\textbf{Solution:} The \Sexpr{which(eq==40)}th element in the vector is the solution which means x must equal \Sexpr{x[which(eq==40)]} (x = 4) for the equation to equal 40.
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % QUESTION 2e
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
